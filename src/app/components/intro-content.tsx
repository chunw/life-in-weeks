...
export function IntroContent() {
  return (
    <div className="intro-content">
      <div className="mt-3">
        <p>This is <a href="https://ls.chunwang.me/">Chun Wang</a>&apos;s life in weeks. Inspired by <a target="_blank" rel="noopener noreferrer" href="https://waitbutwhy.com/2014/05/life-weeks.html">Wait But Why</a>.</p>
